...
class FlowTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Tests if has job finds an existing job.
     */
    public function testHasJobExist()
    {
        $flow = new Flow('test-flow');
    ...
    /**
     * Tests if has job does not find a non existent job.
     */
    public function testHasJobNotExist()
    {
        $flow = new Flow('test-flow');
